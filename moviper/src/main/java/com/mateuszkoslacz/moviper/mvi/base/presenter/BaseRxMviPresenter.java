 ...
 */
public abstract class BaseRxMviPresenter
        ...
        extends CommonMviBasePresenter<ViewType, ViewStateType>
    ...
    public BaseRxMviPresenter() {
        this(null);
    }

    public BaseRxMviPresenter(Bundle args) {
        super(args);

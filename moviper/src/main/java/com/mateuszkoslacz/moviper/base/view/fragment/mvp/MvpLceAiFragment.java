...
package com.mateuszkoslacz.moviper.base.view.fragment.mvp;
 ...
 * @since 1.0.0
 */
public abstract class MvpLceAiFragment<CV extends View, M, V extends MvpLceView<M>, P extends MvpPresenter<V>>
        extends MvpAiFragment<V, P> implements MvpLceView<M> {

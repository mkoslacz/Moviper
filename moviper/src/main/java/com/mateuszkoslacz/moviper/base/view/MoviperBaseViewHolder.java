...
public abstract class MoviperBaseViewHolder<V extends MvpView, P extends MvpPresenter<V>> extends RecyclerView.ViewHolder implements BaseMvpDelegateCallback<V, P>, MvpView {

    protected P presenter;
    protected ViewGroupMvpDelegate<V, P> mvpDelegate;

    public MoviperBaseViewHolder(View itemView) {
        super(itemView);
    }

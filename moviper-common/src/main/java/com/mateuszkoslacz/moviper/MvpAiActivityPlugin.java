 ...
 * @since 1.0.0
 */
public abstract class MvpAiActivityPlugin<V extends MvpView, P extends MvpPresenter<V>>
        extends ActivityPlugin implements MvpView,
    ...
    @NonNull protected ActivityMvpDelegate<V, P> getMvpDelegate() {
        if (mvpDelegate == null) {
            mvpDelegate = new ActivityPluginMvpDelegateImpl(this, this, true);
        }

 ...
 */
public abstract class MvpLceAiActivity<CV extends View, M, V extends MvpLceView<M>, P extends MvpPresenter<V>>
        extends MvpAiActivity<V, P> implements MvpLceView<M> {

 ...
 * @since 1.1.0
 */
public class ActivityPluginMvpDelegateImpl<V extends MvpView, P extends MvpPresenter<V>>
  ...
  private static final String DEBUG_TAG = "ActivityPluginMvpDelegateImpl";

  private MvpDelegateCallback<V, P> delegateCallback;
  protected boolean keepPresenterInstance;
  protected ActivityPlugin activity;
   ...
   */
  public ActivityPluginMvpDelegateImpl(@NonNull ActivityPlugin activity,
  ...
  private P createViewIdAndCreatePresenter() {
    ...
    if (keepPresenterInstance) {
      ...
      PresenterManager.putPresenter(activity.getActivity(), mosbyViewId, presenter);
    }
    return presenter;
  }
  ...
  @Override public void onCreate(Bundle bundle) {
    ...
    if (bundle != null && keepPresenterInstance) {
      ...
      if (mosbyViewId != null
          && (presenter = PresenterManager.getPresenter(activity.getActivity(), mosbyViewId)) != null) {
        //
  ...
  @Override public void onDestroy() {
    boolean retainPresenterInstance = retainPresenterInstance(keepPresenterInstance, activity.getActivity());
    getPresenter().detachView(retainPresenterInstance);
    if (!retainPresenterInstance && mosbyViewId != null) {
      PresenterManager.remove(activity.getActivity(), mosbyViewId);
    }

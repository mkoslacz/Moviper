...
public class ListingActivityTest {
    ...
    public void testDataFetchingWithSuccess() {
        ...
        ((TestRepository<User>) DIProvider.getRepositoryComponent().provideUserRepository()).triggerContentReturn();
    ...
    public void testDataFetchingWithError() {
        shouldLoadingViewBeDisplayed();
        ((TestRepository<User>) DIProvider.getRepositoryComponent().provideUserRepository()).triggerError(new IllegalStateException());

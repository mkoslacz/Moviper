 ...
 */
public class MoviperRecyclerPresentersDispatcher extends MoviperPresentersDispatcher {

    private static final String EXTRA_VIEW_ID = "EXTRA_VIEW_ID";
    private static MoviperRecyclerPresentersDispatcher mInstance;
    private SparseArray<ViperPresenter> mPresenters = new SparseArray<>(); // TODO: 27.12.2016 SparseArray or HashMap?

    private MoviperRecyclerPresentersDispatcher() {
    }

    public static MoviperRecyclerPresentersDispatcher getInstance() {
        if (mInstance == null) {
            mInstance = new MoviperRecyclerPresentersDispatcher();
        }
        return mInstance;
    }

    @VisibleForTesting
    public static void setInstance(MoviperRecyclerPresentersDispatcher mInstance) {
        MoviperRecyclerPresentersDispatcher.mInstance = mInstance;
    }
